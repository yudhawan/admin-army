...
function Users() {
  ...
  return (
    <div className='flex flex-col w-full h-full space-y-5'>
      ...
      {addshow?<AddUser handleAddshow={handleAddshow} />:editshow.show?<EditUser handleEditshow={handleEditshow}/>:<><div className='flex justify-between w-full'>
      ...
      {deleteshow.show&&<DeleteUser handleDeleteShow={handleDeleteShow}/>}
        <table className='w-full text-left overflow-x-scroll'>
            ...
            <tbody className='overflow-y-auto w-full h-[65vh] flex flex-col bg-white rounded-br-md rounded-bl-md'>
              <tr  className="flex w-full lg:w-full justify-center py-3 px-4 border-b border-gray-100 h-12">
                {/* <td className='h-auto w-[15vw] lg:w-[5%] '>1</td> */}
                <td className='h-auto w-[50vw] lg:w-[30%]'>yayan</td>
                <td className='h-auto w-[85vw] lg:w-[35%]'>yayansuhatra_dsad@mail.com</td>
                <td className='h-auto w-[40vw] lg:w-[25%]'>085765410909</td>
